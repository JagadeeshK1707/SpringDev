...
public class Person {
	...
	/*
	 * Auto -  means jpa creates the sequence here every thing will take by JPA , it will work for every data base
	 * identity  - means take care by Database , it works for particular database
	 * 
	 * 
	 */
